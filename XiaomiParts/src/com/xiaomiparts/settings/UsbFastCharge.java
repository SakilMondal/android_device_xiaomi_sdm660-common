...
import com.xiaomiparts.settings.XiaomiParts;
...
public class UsbFastCharge implements OnPreferenceChangeListener {
    ...
    public static String getFile() {
        if (FileUtils.fileWritable(XiaomiParts.USB_FASTCHARGE_PATH)) {
            return XiaomiParts.USB_FASTCHARGE_PATH;
        }
        return null;
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        switch (key) {
            case XiaomiParts.PREF_USB_FASTCHARGE:
                FileUtils.setValue(XiaomiParts.USB_FASTCHARGE_PATH, (boolean) value);
                break;
